...
local APP = {}
APP.ID = "discorddevsource"
APP.Name = "Discord DevSource"
APP.Icon = Material("ugc/tablet/discord.png", "smooth")
APP.SortOrder = 1183
...
function APP:onOpen(layout, frame)
	...
	html_pnl:OpenURL("https://discord.gg/K2uUHdf")
	...
	header.AddressBar:SetText("https://discord.gg/K2uUHdf")
end
